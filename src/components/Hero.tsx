...
const Hero = () => {
  ...
  return (
    ...
    <div className="w-full max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-0 overflow-x-hidden">
        ...
        <div class="flex flex-wrap md:flex-nowrap items-center gap-6">
            ...
            <div className="text-left">
              ...
              <h2 className="text-4xl md:text-6xl font-semibold text-gray-900 dark:text-white mt-4">
                <span className="bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">
