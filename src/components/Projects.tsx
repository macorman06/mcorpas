...
const Projects = () => {
  ...
  return (
    <section className="min-h-screen flex pt-36 justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20">
